...
class ContaEmpresa:
    def __init__(self):
        self.banco_informacoes = []
    
    def inclusao_titulo(self, tipo_titulo):
        self.banco_informacoes.append(tipo_titulo)
...
if __name__ == '__main__':
    ...
    ContaMon.inclusao_titulo(conta_cheque)

    for i in ContaMon.banco_informacoes:
        print(i.get_fornecedor())
