...
class Debito:
    def __init__(self, valor:float, data_emissao:str, data_vencimento:str, fornecedor:str, pedido:str, status = 0) -> None:
        self._valor = valor 
...
class Boleto(Debito):
    def __init__(self, valor: float, data_emissao: str, data_vencimento: str, fornecedor: str, pedido: str, numero_boleto: int, protesto: bool, dias_protesto: int, status,parcelas = None) -> None:
