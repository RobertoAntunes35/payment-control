...
if __name__ == '__main__':
    ...
    # novo_cheque =  sch.Cheque(
    #     valor = conta_cheque.get_valor(),
    #     dataEmissao = conta_cheque.get_data_emissao(),
    #     dataPagamento = conta_cheque.get_data_emissao(),
    #     dataVencimento = conta_cheque.get_data_vencimento(),
    #     fornecedor = conta_cheque.get_fornecedor(),
    #     pedido = conta_cheque.get_pedido(),
    #     statusPagamento = conta_cheque.get_status(),

    #     numeroBoleto = conta_cheque.get_numero_boleto(),
    #     protesto = conta_cheque.get_protesto()
    # )
